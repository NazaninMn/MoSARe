...
def main(args):
	...
	for i in folds:
		...
		if args.task_type == 'classification':
			val_latest, result_dict = train(datasets, i, args)

		f1_scores+=[result_dict['f1']]
		precision_scores+=[result_dict['precision']]
		recall_scores+=[result_dict['recall']]
		accuracy_scores+=[result_dict['accuracy']]
		auc_scores+=[result_dict['auc']]
