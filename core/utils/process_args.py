...
def process_args():
    ...
    parser = argparse.ArgumentParser(description='Configurations for MoSARE pretraining')

    parser.add_argument('--study', type=str, default='lung', help='Study: brca, nsclc or pancancer')

    #-----> model args 
    parser.add_argument('--embedding_dim', type=int, default=1024, help='Size of the embedding space')
    parser.add_argument('--rna_encoder', type=str, default="abmil_mh", help='MLP or Linear.') 
    ...
    parser.add_argument('--hidden_dim', type=int, default=256, help='Internal dim of ABMIL.')
    ...
    parser.add_argument('--mask_percentage', type=float, default=0.0, help='Percentage of n_tokens that is masked during Intra loss computation.')
    ...
    parser.add_argument('--intra_modality_mode_wsi', type=str, default='cont', help='Type of Intra loss. Options are: reconstruct_avg_emb, reconstruct_masked_emb.')
    ...
    parser.add_argument('--method', type=str, default='mosare', help='Train recipe.')
